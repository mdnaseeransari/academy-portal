...
<section id="about" class="bg-gray-50 py-20">
    <div class="container mx-auto px-6">
        ...
        <!-- Why Choose Us -->
        <div class="mb-20">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12">Why Choose Us?</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto">
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Because great students are guided by ever greater teachers</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Regular exam-oriented mock tests conducted every Sunday</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Proven record of delivering toppers year after year</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Fully air-conditioned classrooms for comfortable learning</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Smart board equipped classrooms for interactive learning</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Biometric attendance system ensuring discipline and transparency</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">24×7 CCTV monitoring for complete safety and security</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">RO water cooler dispenser providing clean drinking water</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Fully Wi-Fi enabled campus</p>
                </div>
                <div class="flex items-center gap-3">
                    <span class="text-green-600 text-xl">✔</span>
                    <p class="text-gray-700">Proper and secure parking facility available</p>
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <div class="text-center">
                    <div class="w-16 h-16 bg-[#2c3e80] text-white rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-lg">AA</div>
