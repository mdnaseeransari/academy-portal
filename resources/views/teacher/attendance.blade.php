                ...
                <div>
                    ...
                    <div class="flex flex-col gap-3 mb-6">
                        @foreach($available_slots as $slot)
                            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-[#2c3e80] transition {{ $periodSlot == $slot->period_slot ? 'ring-2 ring-[#2c3e80]' : '' }}">
                                <div>
