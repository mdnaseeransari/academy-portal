                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex flex-col justify-between">
                    ...
                    <div class="space-y-4">
                        @if($assignment->file_path)
                            <a href="{{ Storage::url($assignment->file_path) }}" download class="inline-flex items-center gap-2 bg-white text-gray-700 border border-gray-300 px-4 py-2 rounded-lg hover:bg-gray-50 text-xs transition font-bold">
